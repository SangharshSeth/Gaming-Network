<script lang="ts">
  ...
  <title> Login </title>
  <meta
    content="This is a Signup Page for Learning App Developed by Sangharsh Seth"
    name="description"
  />
  ...
  >
    <div class=" bg-white py-8 px-6 shadow rounded-xl sm:px-10" style="height: 730px;">
      <div class="sm: mx-auto sm: w-full sm: max-w-md">
        ...
        >
          <p class="font-bold text-emerald-600 text-2xl font-sans-serif " >Login to Your Account</p>
          <p class="text-sm" >Dont have a account? <a class="text-emerald-600" href="/signup" >Join Now</a></p>
        </div>
        <form
          action="?/login"
          class="mb-0 space-y-6 flex flex-col flex-1 h-full"
          method="POST"
        >
          <div class="mt-0 mb-0 flex flex-col gap-4">
            <div>
            ...
            <div class="flex flex-row gap-1 items-center content-center">
              <label for="terms" class="text-gray-700 text-sm font-medium">Forgot your Password? <a href="/forgot" class="text-emerald-700 ">Reset Here.</a></label>
            </div>
            <button
